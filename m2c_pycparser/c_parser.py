...
class CParser(PLYParser):
    ...
    def p_gcc_attribute(self, p):
        """ gcc_attribute   : __ATTRIBUTE__ LPAREN LPAREN gcc_attribute_list_opt RPAREN RPAREN
        """
        p[0] = p[4] or []
    ...
    def p_gcc_attribute_item(self, p):
        ...
        if not p[1]:
            ...
            if len(p) > 2:
                args = p[3].exprs
            p[0] = [c_ast.GccAttribute(p[1], args, coord=self._token_coord(p, 1))]
